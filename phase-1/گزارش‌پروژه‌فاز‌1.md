...
| الگوریتم | زمان (بهترین) | زمان (میانگین) | زمان (بدترین) | فضا |
|----------|---------------|----------------|---------------|-----|
| Semantic BFS | O(1) | O(V + E) | O(V + E) | O(V) |
| Dijkstra | O(V log V) | O((V + E) log V) | O((V + E) log V) | O(V) |
| A* | O(V log V) | O((V + E) log V) | O((V + E) log V) | O(V) |
| Hybrid | O(V + E) | O((V + E) log V) | O((V + E) log V) | O(V) |
